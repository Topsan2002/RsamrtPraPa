...
import 'package:rsmart/TypeData/dataReciveBin.dart';
...
class PrintReciveBin extends StatefulWidget {
  const PrintReciveBin({Key? key}) : super(key: key);

  @override
  _PrintReciveBinState createState() => _PrintReciveBinState();
}

class _PrintReciveBinState extends State<PrintReciveBin> {
  ...
  void peviceData() async {
    var url = Uri.parse(
        "http://${path}/appapi/rsmart/api/appApi/User/api_recive_bin.php");
    ...
    var mapData = dataReciveBinFromJson(jsonEncode(res['data']));
