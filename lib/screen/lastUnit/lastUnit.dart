...
class _LastUnitState extends State<LastUnit> {
 ...
 // final StreamController _steam = new StreamController();
  ...
  mon = ['','มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฎาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิหายน', 'ธันวาคม'];
  ...
  Future getData() async{
    ...
    var url = Uri.parse("http://${path}/appapi/rsmart/api/appApi/User/api_search_member_last_use.php");
 ...
 void getWaterId(String waterID, String nameMember) async {
    ...
    //print(waterID);
     Navigator.push(
      context,
      PageTransition(child: ManegeLastUnit(), type: PageTransitionType.rightToLeft)
      );
